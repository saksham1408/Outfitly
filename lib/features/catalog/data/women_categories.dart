...
/// Category row shown exclusively at the top of the WOMEN tab.
const List<TabCategory> womenCategories = [
  TabCategory(name: 'Ethnic', icon: Icons.dry_cleaning_rounded),
