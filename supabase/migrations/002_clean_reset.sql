-- ============================================================
-- Outfitly: Clean reset — drops existing objects and recreates
-- ============================================================
...
drop policy if exists "Users can read own preferences" on public.style_preferences;
drop policy if exists "Users can upsert own preferences" on public.style_preferences;
...
drop table if exists public.style_preferences cascade;
